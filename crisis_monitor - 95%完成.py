...
def run_data_pipeline():
    ...
    try:
        result = subprocess.run([sys.executable, "scripts/sync_fred_http.py"], 
    ...
    try:
        result = subprocess.run([sys.executable, "scripts/calculate_corporate_debt_gdp_ratio.py"], 
    ...
    try:
        result = subprocess.run([sys.executable, "scripts/calculate_yoy_indicators.py"], 
